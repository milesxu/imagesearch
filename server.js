...
const dbUrl = 'mongodb://milesxu:hM73DseS17pu@ds062339.mlab.com:62339/mongo'
const key1 = '7c58b30f8f7a4a6b930759332af433ed';
const key2 = 'df62649f932445b2a7ae8fbe93b652ec';
let options = {
    hostname: 'api.cognitive.microsoft.com',
    path: '/bing/v5.0/images/search',
    headers: {
        'Ocp-Apim-Subscription-Key': Math.random() > 0.5 ? key1 : key2
    },
    agent: false
}
